...
class ProductsRepository {
  static List<Product> loadProducts(Category category, {String keyword = ''}) {
    ...
    List<Product> filteredProducts = category == Category.all
        ? allProducts
    ...
    if (keyword.isNotEmpty) {
      ...
      product.name.toLowerCase().contains(lowercaseKeyword) ||
          product.price.toString().contains(lowercaseKeyword)
      ).toList();
    }
